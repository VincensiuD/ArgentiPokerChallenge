...
describe("Retrieving the key of a dictionary from the value", ( )=>{
  ...
  describe("Retrieving one of the Card object that is part of a pair in player's hand", ( )=>{
    test("Returns a card object", () => {
      ...
      const player: Player = { hands:
         [{rank:5,suit:"H"},{rank:12,suit:"D"},{rank:12,suit:"S"},{rank:12,suit:"C"},{rank:8,suit:"S"}]
        ,highestCard : {rank:12,suit:"D"}, secondHighestCard : {rank:8,suit:"S"}, pokerRank : 0
        }
